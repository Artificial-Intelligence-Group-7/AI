Assignment 1 Group 7 README FILE
...
STEPS
1)  Open the part 2 folder, run the 2.py file in python3.
2)  The program asks you to enter a number, Enter 1 for Genetic Algorithm and 2 for hill climbing.
3) 
